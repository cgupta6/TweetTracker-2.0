...
app.controller('advancedAnalyticsCtrl',[ '$http','$state','$scope','$rootScope','$location', '$mdSidenav','NgTableParams',
 ...
 dynamicHeader.setReportTab('/advancedAnalytics');
    ...
    $scope.toggleLeftStack = buildTogglerStack('left');
    ...
    $scope.toggleLeftStack2 = buildTogglerStack2('left');
    ...
    function buildTogglerStack(componentId) {
        return function() {
            $mdSidenav(componentId).toggle();
            $scope.showMainMenu=false;
             $scope.showMapMenu=false;
    ...
    function buildTogglerStack2(componentId) {
        return function() {
            $scope.showMainMenu=false;
             $scope.showMapMenu=false;
             $scope.showTweetMenu=false;
