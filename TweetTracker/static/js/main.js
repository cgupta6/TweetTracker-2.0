...
app.config(['$routeProvider', function ($routeProvider) {
    ...
    // Home
        ...
        .when("/myProfile", {templateUrl: "/myProfile", controller: "profileCtrl"})
        .when("/contact", {templateUrl: "templates/contact.html", controller: "PageCtrl"})
        .when("/editReport", {templateUrl: "templates/UpdateReport.html", controller: "PageCtrl"})
        .when("/newReport", {templateUrl: "/newReport", controller: "PageCtrl"})
        // Blog
        ...
        .when("/myJobs", {templateUrl: "/myJobs", controller: "AppCtrl"})
        .when("/basicstats", {templateUrl: "templates/basicstats.html", controller: "AppCtrl"})
        // else 404
